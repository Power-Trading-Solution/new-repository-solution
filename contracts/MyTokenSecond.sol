...
contract MyTokenSecond is ERC20, Ownable {
    ...
    constructor(uint256 initialSupply, uint256 _tokensPerLETH, uint256 _tokensPerUSDS, uint256 _tokensPerMTF, uint256 _tokensPerATT, uint256 _tokensPerATF, uint256 _tokensPerLTF) 
    ERC20("MyTokenSecond", "MTS") Ownable(msg.sender) {
