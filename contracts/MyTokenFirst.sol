...
contract MyTokenFirst is ERC20, Ownable {
    ...
    constructor(uint256 initialSupply, uint256 _tokensPerLETH, uint256 _tokensPerUSDS, uint256 _tokensPerMTS, uint256 _tokensPerATT, uint256 _tokensPerATF, uint256 _tokensPerLTF) 
    ERC20("MyTokenFirst", "MTF") Ownable(msg.sender) {
