<template>
    <div class="page-container">
      ...
      <div v-if="connected" class="form-container">
        ...
        <input v-model="tokenUSDSAmount" class="input-field" placeholder="Amount of tokens USDS" />
        <input v-model="tokenETHAmount" class="input-field" placeholder="Amount of tokens ETH" />
        <button @click="phaseFirst" class="action-button">Deposit Tokens </button>
      </div>
  
      <div v-if="connected" class="form-container">
      <!--<button @click="phaseSecond" class="action-button">Phase Second: Swap Tokens</button>-->
      <button @click="phaseThird" class="action-button">Withdraw</button>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
        ...
        if (window.ethereum) { 
          window.ethereum.request({ method: 'eth_requestAccounts' })
            .then(async () => {
              ...
              console.log("usds", managerBalance)
              ...
              console.log("eth", managerBalance1)

              const tokenContractProvider11 = new ethers.Contract(ETHAddress, ERC20_ABI, provider)
              const managerBalance11 = await tokenContractProvider11.balanceOf("0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9");
              console.log("eth swap", managerBalance11)
      ...
      async phaseFirst() {
        ...
        const amountUSDS = ethers.parseUnits(this.tokenUSDSAmount, 18);
        const amountETH = ethers.parseUnits(this.tokenETHAmount, 18);
        ...
        await this.managerContract.depositTokens(USDSAddress, amountUSDS)
        ...
        await this.managerContract.depositTokens(ETHAddress, amountETH);
